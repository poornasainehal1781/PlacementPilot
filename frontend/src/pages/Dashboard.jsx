...
export default function Dashboard() {
    ...
    const COLORS = ['#6366f1', '#4f46e5', '#3b82f6', '#10b981', '#f59e0b', '#ef4444'];
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-10 space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-white tracking-tight">Your Talent Dashboard</h1>
                    <p className="text-slate-400 text-sm mt-1">Review your ATS optimization history and readiness levels.</p>
                </div>
                <button
                    onClick={() => navigate('/analyze')}
                    className="bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-6 py-3.5 rounded-xl transition-all shadow-lg shadow-indigo-600/20 flex items-center gap-2 group"
                >
            ...
            {/* Empty state check */}
            {total_analyses === 0 ? (
                <Card className="py-16 text-center flex flex-col items-center max-w-2xl mx-auto">
                    <FileText className="w-16 h-16 text-slate-600 mb-4 animate-bounce" />
                    <h3 className="text-xl font-bold text-slate-200">No Resume Analyses Yet</h3>
                ...
                <>
                        ...
                        <Card className="relative overflow-hidden">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <h3 className="text-3xl font-black text-white mt-1.5">{average_ats_score}%</h3>
                                </div>
                                <div className="p-2.5 bg-indigo-600/20 text-indigo-400 border border-indigo-500/20 rounded-xl">
                        ...
                        <Card>
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <h3 className="text-3xl font-black text-white mt-1.5">{total_resumes}</h3>
                                </div>
                        ...
                        <Card>
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <h3 className="text-3xl font-black text-white mt-1.5">{total_analyses}</h3>
                                </div>
                                <div className="p-2.5 bg-blue-500/20 text-blue-400 border border-blue-500/20 rounded-xl">
                        ...
                        <Card>
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <h3 className="text-3xl font-black text-white mt-1.5">{readiness_level}</h3>
                                </div>
                                <div className="p-2.5 bg-amber-500/20 text-amber-400 border border-amber-500/20 rounded-xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <Card className="lg:col-span-2" hover={false}>
                            <h3 className="text-base font-bold text-slate-200 mb-6">ATS Score Trend</h3>
                        ...
                        <Card hover={false}>
                            <h3 className="text-base font-bold text-slate-200 mb-6">Top Missing Skills</h3>
                    ...
                    <Card hover={false}>
                        <h3 className="text-base font-bold text-slate-200 mb-6">Recent Analysis Reports</h3>
                                        ...
                                        <tr key={item.id} className="group hover:bg-slate-800/10">
                                            ...
                                            <td className="py-4 text-right">
                                                <button
                                                    ...
                                                    className="bg-indigo-600/10 text-indigo-400 hover:bg-indigo-600 hover:text-white border border-indigo-500/20 px-3.5 py-1.5 rounded-lg text-xs font-semibold transition-all"
                                                >
                                                    View Details
                                                </button>
                                            </td>
